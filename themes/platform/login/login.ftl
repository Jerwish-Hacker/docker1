                ...
                <div class="${properties.kcLoginCard!}">
                    <div class="${properties.kcContainerWrapper!}">
                        <div class="${properties.kcLeftItem!}">
                            <img src="${properties.kcLoginCardCoverImg!}" alt="login"
                                 class="${properties.kcLoginMainImg!}">
                        </div>
                            ...
                            <div class="${properties.kcFormBody!}">
                                <div class="${properties.kcBrandWrapper}">
                                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                         ...
                                         viewBox="0 0 252.3 67.7" style="enable-background:new 0 0 252.3 67.7;"
                                         xml:space="preserve">
<style type="text/css">
    .st0 {
        fill-rule: evenodd;
    ...
    .st7 {
		...
		c-0.3-0.5-0.3-1-0.1-1.4L237.9,56.3z M237.9,56.3"/>
                                            <g>
                                                <path class="st6"
                                                      d="M123.3,22.5l-3.6-10.1L118.4,23l0.3,3.2l4.9-0.5L123.3,22.5z M123.3,22.5"/>
                                                <path class="st7"
                                                      d="M119.8,12.4l-0.5,4.1l1.9-0.2L119.8,12.4z M119.8,12.4"/>
                                ...
                                <div id="kc-form-wrapper">
                                    <#if realm.password>
                                        ...
                                        >
                                            ...
                                            <input tabindex="4" class="btn btn-block login-btn mb-4" name="login" id=""
                                                   type="submit" value="Sign In">
                                        </form>
                                    </#if>
                                    <div>
                                        <#if realm.resetPasswordAllowed>
                                            <span><a class="${properties.kcFormOptionsWrapperClass!}" tabindex="5"
